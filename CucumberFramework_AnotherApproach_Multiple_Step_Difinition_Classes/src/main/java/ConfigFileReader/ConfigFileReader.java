...
FileInputStream ip = new FileInputStream(new File("C:\\Users\\se.malone\\eclipse-workspace\\CucumberFramework_AnotherApproach_Multiple_Step_Difinition_Classes\\Configs\\Configuration.properties"));
//load all objects
p.load(ip);
//return p;
}
